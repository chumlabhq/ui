...
- generic [ref=e3]:
    - generic:
        ...
        - main [ref=e19]:
            - generic [ref=e21]:
                - heading "Ship products te" [level=1] [ref=e25]:
                    - text: Ship products
                    - generic [ref=e26]: te
            ...
            - generic [ref=e191]:
                ...
                - generic [ref=e195]:
                    - link "LocalStorage vs Cookies vs SessionStorage (Complete Guide) Frontend 22 min read LocalStorage vs Cookies vs SessionStorage (Complete Guide) localStorage persists for years, sessionStorage dies with the tab, and cookies ride along on every HTTP request. Here's how to compare them without mixing up lifetimes, scope, or security. April 3, 2026 Read more" [ref=e196] [cursor=pointer]:
                        - /url: /blog/localstorage-cookies-sessionstorage-guide
                        - img "LocalStorage vs Cookies vs SessionStorage (Complete Guide)" [ref=e198]
                        - generic [ref=e199]:
                            - generic [ref=e200]:
                                - generic [ref=e201]: Frontend
                                - generic [ref=e202]: 22 min read
                            - heading "LocalStorage vs Cookies vs SessionStorage (Complete Guide)" [level=3] [ref=e203]
                            - paragraph [ref=e204]: localStorage persists for years, sessionStorage dies with the tab, and cookies ride along on every HTTP request. Here's how to compare them without mixing up lifetimes, scope, or security.
                            - generic [ref=e205]:
                                - generic [ref=e206]: April 3, 2026
                                - generic [ref=e207]:
                                    - text: Read more
                                    - img [ref=e208]
                    - link "Async JavaScript Explained (Promises, Async/Await, Event Loop) JavaScript 15 min read Async JavaScript Explained (Promises, Async/Await, Event Loop) When you click a button or fetch data from an API, JavaScript keeps moving forward while handling tasks in the background. This guide breaks down promises, async/await, and the event loop. March 31, 2026 Read more" [ref=e210] [cursor=pointer]:
                        - /url: /blog/async-javascript-explained
                        - img "Async JavaScript Explained (Promises, Async/Await, Event Loop)" [ref=e212]
                        - generic [ref=e213]:
                            - generic [ref=e214]:
                                - generic [ref=e215]: JavaScript
                                - generic [ref=e216]: 15 min read
                            - heading "Async JavaScript Explained (Promises, Async/Await, Event Loop)" [level=3] [ref=e217]
                            - paragraph [ref=e218]: When you click a button or fetch data from an API, JavaScript keeps moving forward while handling tasks in the background. This guide breaks down promises, async/await, and the event loop.
                            - generic [ref=e219]:
                                - generic [ref=e220]: March 31, 2026
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - link "What is Frontend Development? Complete Guide (2026) Frontend 18 min read What is Frontend Development? Complete Guide (2026) Frontend development is the process of building the visual and interactive part of a website. In 2026, it's about performance, usability, accessibility, and business impact. March 28, 2026 Read more" [ref=e224] [cursor=pointer]:
                        - /url: /blog/what-is-frontend-development
                        - img "What is Frontend Development? Complete Guide (2026)" [ref=e226]
                        - generic [ref=e227]:
                            - generic [ref=e228]:
                                - generic [ref=e229]: Frontend
                                - generic [ref=e230]: 18 min read
                            - heading "What is Frontend Development? Complete Guide (2026)" [level=3] [ref=e231]
                            - paragraph [ref=e232]: Frontend development is the process of building the visual and interactive part of a website. In 2026, it's about performance, usability, accessibility, and business impact.
                            - generic [ref=e233]:
                                - generic [ref=e234]: March 28, 2026
                                - generic [ref=e235]:
                                    - text: Read more
                                    - img [ref=e236]
