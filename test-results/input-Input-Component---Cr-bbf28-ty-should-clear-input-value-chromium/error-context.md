...
- generic [ref=e3]:
    - generic:
        ...
        - main [ref=e19]:
            - generic [ref=e21]:
                - heading "Ship products i" [level=1] [ref=e25]:
                    - text: Ship products
                    - generic [ref=e26]: i
            ...
            - generic [ref=e191]:
                ...
                - generic [ref=e195]:
                    - link "Code Splitting & Lazy Loading in Modern Web Apps Performance 16 min read Code Splitting & Lazy Loading in Modern Web Apps Most apps load everything upfront. That's why they feel slow. Code splitting and lazy loading help you reduce initial load time, improve performance, and deliver a smoother experience. April 2, 2026 Read more" [ref=e196] [cursor=pointer]:
                        - /url: /blog/code-splitting-lazy-loading
                        - img "Code Splitting & Lazy Loading in Modern Web Apps" [ref=e198]
                        - generic [ref=e199]:
                            - generic [ref=e200]:
                                - generic [ref=e201]: Performance
                                - generic [ref=e202]: 16 min read
                            - heading "Code Splitting & Lazy Loading in Modern Web Apps" [level=3] [ref=e203]
                            - paragraph [ref=e204]: Most apps load everything upfront. That's why they feel slow. Code splitting and lazy loading help you reduce initial load time, improve performance, and deliver a smoother experience.
                            - generic [ref=e205]:
                                - generic [ref=e206]: April 2, 2026
                                - generic [ref=e207]:
                                    - text: Read more
                                    - img [ref=e208]
                    - 'link "Design Systems in Frontend: Why Every Product Needs One Architecture 18 min read Design Systems in Frontend: Why Every Product Needs One Products like Airbnb, Uber, and Stripe feel consistent because they use design systems. If you''re building anything serious, this is not optional. It''s one of the most important things you can implement early. April 3, 2026 Read more" [ref=e210] [cursor=pointer]':
                        - /url: /blog/design-systems-frontend
                        - 'img "Design Systems in Frontend: Why Every Product Needs One" [ref=e212]'
                        - generic [ref=e213]:
                            - generic [ref=e214]:
                                - generic [ref=e215]: Architecture
                                - generic [ref=e216]: 18 min read
                            - 'heading "Design Systems in Frontend: Why Every Product Needs One" [level=3] [ref=e217]'
                            - paragraph [ref=e218]: Products like Airbnb, Uber, and Stripe feel consistent because they use design systems. If you're building anything serious, this is not optional. It's one of the most important things you can implement early.
                            - generic [ref=e219]:
                                - generic [ref=e220]: April 3, 2026
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - 'link "How the Web Works: From URL to Page Load Web Fundamentals 14 min read How the Web Works: From URL to Page Load Behind every page load is a complex chain of events involving browsers, servers, networks, and code working together in milliseconds. This guide breaks it down so you actually understand the web. March 30, 2026 Read more" [ref=e224] [cursor=pointer]':
                        - /url: /blog/how-the-web-works
                        - 'img "How the Web Works: From URL to Page Load" [ref=e226]'
                        - generic [ref=e227]:
                            - generic [ref=e228]:
                                - generic [ref=e229]: Web Fundamentals
                                - generic [ref=e230]: 14 min read
                            - 'heading "How the Web Works: From URL to Page Load" [level=3] [ref=e231]'
                            - paragraph [ref=e232]: Behind every page load is a complex chain of events involving browsers, servers, networks, and code working together in milliseconds. This guide breaks it down so you actually understand the web.
                            - generic [ref=e233]:
