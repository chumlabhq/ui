...
- generic [ref=e3]:
    - generic:
        ...
        - main [ref=e19]:
            - generic [ref=e21]:
                - heading "Ship products teams dream" [level=1] [ref=e25]:
                    - text: Ship products
                    - generic [ref=e26]: teams dream
            ...
            - generic [ref=e191]:
                ...
                - generic [ref=e195]:
                    - link "How APIs Work in Frontend (REST vs GraphQL) Frontend 15 min read How APIs Work in Frontend (REST vs GraphQL) Every login, dashboard, feed, or form submission talks to an API behind the scenes. Here's how requests flow, how REST fits together, and when GraphQL earns its complexity. April 2, 2026 Read more" [ref=e196] [cursor=pointer]:
                        - /url: /blog/apis-frontend-rest-vs-graphql
                        - img "How APIs Work in Frontend (REST vs GraphQL)" [ref=e198]
                        - generic [ref=e199]:
                            - generic [ref=e200]:
                                - generic [ref=e201]: Frontend
                                - generic [ref=e202]: 15 min read
                            - heading "How APIs Work in Frontend (REST vs GraphQL)" [level=3] [ref=e203]
                            - paragraph [ref=e204]: Every login, dashboard, feed, or form submission talks to an API behind the scenes. Here's how requests flow, how REST fits together, and when GraphQL earns its complexity.
                            - generic [ref=e205]:
                        ...
                        - generic [ref=e213]:
                            ...
                            - generic [ref=e219]:
                                ...
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - link "Code Splitting & Lazy Loading in Modern Web Apps Performance 16 min read Code Splitting & Lazy Loading in Modern Web Apps Most apps load everything upfront. That's why they feel slow. Code splitting and lazy loading help you reduce initial load time, improve performance, and deliver a smoother experience. April 2, 2026 Read more" [ref=e224] [cursor=pointer]:
                        - /url: /blog/code-splitting-lazy-loading
                        - img "Code Splitting & Lazy Loading in Modern Web Apps" [ref=e226]
                        - generic [ref=e227]:
                            - generic [ref=e228]:
                                - generic [ref=e229]: Performance
                                - generic [ref=e230]: 16 min read
                            - heading "Code Splitting & Lazy Loading in Modern Web Apps" [level=3] [ref=e231]
                            - paragraph [ref=e232]: Most apps load everything upfront. That's why they feel slow. Code splitting and lazy loading help you reduce initial load time, improve performance, and deliver a smoother experience.
                            - generic [ref=e233]:
