...
- generic [ref=e3]:
    - generic:
        ...
        - main [ref=e19]:
            - generic [ref=e21]:
                - heading "Ship products t" [level=1] [ref=e25]:
                    - text: Ship products
                    - generic [ref=e26]: t
                        ...
                        - generic [ref=e199]:
                            ...
                            - generic [ref=e205]:
                                ...
                                - generic [ref=e207]:
                                    - text: Read more
                                    - img [ref=e208]
                    - link "React Hooks Explained (useState, useEffect, useMemo) React 14 min read React Hooks Explained (useState, useEffect, useMemo) useState holds data, useEffect syncs with the world after render, and useMemo skips expensive work when inputs are unchanged. Here is how the three fit together in real apps. April 5, 2026 Read more" [ref=e210]:
                        - /url: /blog/react-hooks-explained-usestate-useeffect-usememo
                        - img "React Hooks Explained (useState, useEffect, useMemo)" [ref=e212]
                        - generic [ref=e213]:
                            - generic [ref=e214]:
                                - generic [ref=e215]: React
                                - generic [ref=e216]: 14 min read
                            - heading "React Hooks Explained (useState, useEffect, useMemo)" [level=3] [ref=e217]
                            - paragraph [ref=e218]: useState holds data, useEffect syncs with the world after render, and useMemo skips expensive work when inputs are unchanged. Here is how the three fit together in real apps.
                            - generic [ref=e219]:
                                - generic [ref=e220]: April 5, 2026
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - link "LocalStorage vs Cookies vs SessionStorage (Complete Guide) Frontend 22 min read LocalStorage vs Cookies vs SessionStorage (Complete Guide) localStorage persists for years, sessionStorage dies with the tab, and cookies ride along on every HTTP request. Here's how to compare them without mixing up lifetimes, scope, or security. April 3, 2026 Read more" [ref=e224]:
