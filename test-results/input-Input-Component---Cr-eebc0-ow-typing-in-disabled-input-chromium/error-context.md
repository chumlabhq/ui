    ...
    - generic:
        ...
        - main [ref=e19]:
            ...
            - generic [ref=e191]:
                ...
                - generic [ref=e195]:
                    - link "React Hooks Explained (useState, useEffect, useMemo) React 14 min read React Hooks Explained (useState, useEffect, useMemo) useState holds data, useEffect syncs with the world after render, and useMemo skips expensive work when inputs are unchanged. Here is how the three fit together in real apps. April 5, 2026 Read more" [ref=e196] [cursor=pointer]:
                        - /url: /blog/react-hooks-explained-usestate-useeffect-usememo
                        - img "React Hooks Explained (useState, useEffect, useMemo)" [ref=e198]
                        - generic [ref=e199]:
                            - generic [ref=e200]:
                                - generic [ref=e201]: React
                                - generic [ref=e202]: 14 min read
                            - heading "React Hooks Explained (useState, useEffect, useMemo)" [level=3] [ref=e203]
                            - paragraph [ref=e204]: useState holds data, useEffect syncs with the world after render, and useMemo skips expensive work when inputs are unchanged. Here is how the three fit together in real apps.
                            - generic [ref=e205]:
                                - generic [ref=e206]: April 5, 2026
                                - generic [ref=e207]:
                                    - text: Read more
                                    - img [ref=e208]
                    - link "How APIs Work in Frontend (REST vs GraphQL) Frontend 15 min read How APIs Work in Frontend (REST vs GraphQL) Every login, dashboard, feed, or form submission talks to an API behind the scenes. Here's how requests flow, how REST fits together, and when GraphQL earns its complexity. April 2, 2026 Read more" [ref=e210] [cursor=pointer]:
                        - /url: /blog/apis-frontend-rest-vs-graphql
                        - img "How APIs Work in Frontend (REST vs GraphQL)" [ref=e212]
                        - generic [ref=e213]:
                            - generic [ref=e214]:
                                - generic [ref=e215]: Frontend
                                - generic [ref=e216]: 15 min read
                            - heading "How APIs Work in Frontend (REST vs GraphQL)" [level=3] [ref=e217]
                            - paragraph [ref=e218]: Every login, dashboard, feed, or form submission talks to an API behind the scenes. Here's how requests flow, how REST fits together, and when GraphQL earns its complexity.
                            - generic [ref=e219]:
                                - generic [ref=e220]: April 2, 2026
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - link "What is Next.js? Complete Guide with Use Cases React 14 min read What is Next.js? Complete Guide with Use Cases React handles the UI, but not routing, SEO, performance, or backend logic. Next.js takes React and turns it into a complete framework for building production-ready apps. April 1, 2026 Read more" [ref=e224] [cursor=pointer]:
