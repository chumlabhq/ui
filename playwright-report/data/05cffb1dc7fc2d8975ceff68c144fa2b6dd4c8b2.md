    ...
    - generic:
        ...
        - main [ref=e19]:
            ...
            - generic [ref=e191]:
                ...
                - generic [ref=e195]:
                    - 'link "React vs Angular vs Vue: Which Framework to Choose in 2026? Frontend 18 min read React vs Angular vs Vue: Which Framework to Choose in 2026? React, Angular, and Vue all solve the same problem but in very different ways. This guide cuts through the hype and focuses on how each works, where each shines, and when you should use what. April 2, 2026 Read more" [ref=e196] [cursor=pointer]':
                        - /url: /blog/react-vs-angular-vs-vue
                        - 'img "React vs Angular vs Vue: Which Framework to Choose in 2026?" [ref=e198]'
                        - generic [ref=e199]:
                            - generic [ref=e200]:
                                - generic [ref=e201]: Frontend
                                - generic [ref=e202]: 18 min read
                            - 'heading "React vs Angular vs Vue: Which Framework to Choose in 2026?" [level=3] [ref=e203]'
                            - paragraph [ref=e204]: React, Angular, and Vue all solve the same problem but in very different ways. This guide cuts through the hype and focuses on how each works, where each shines, and when you should use what.
                            - generic [ref=e205]:
                                - generic [ref=e206]: April 2, 2026
                                - generic [ref=e207]:
                                    - text: Read more
                                    - img [ref=e208]
                    - 'link "How the Web Works: From URL to Page Load Web Fundamentals 14 min read How the Web Works: From URL to Page Load Behind every page load is a complex chain of events involving browsers, servers, networks, and code working together in milliseconds. This guide breaks it down so you actually understand the web. March 30, 2026 Read more" [ref=e210] [cursor=pointer]':
                        - /url: /blog/how-the-web-works
                        - 'img "How the Web Works: From URL to Page Load" [ref=e212]'
                        - generic [ref=e213]:
                            - generic [ref=e214]:
                                - generic [ref=e215]: Web Fundamentals
                                - generic [ref=e216]: 14 min read
                            - 'heading "How the Web Works: From URL to Page Load" [level=3] [ref=e217]'
                            - paragraph [ref=e218]: Behind every page load is a complex chain of events involving browsers, servers, networks, and code working together in milliseconds. This guide breaks it down so you actually understand the web.
                            - generic [ref=e219]:
                                - generic [ref=e220]: March 30, 2026
                                - generic [ref=e221]:
                                    - text: Read more
                                    - img [ref=e222]
                    - link "Async JavaScript Explained (Promises, Async/Await, Event Loop) JavaScript 15 min read Async JavaScript Explained (Promises, Async/Await, Event Loop) When you click a button or fetch data from an API, JavaScript keeps moving forward while handling tasks in the background. This guide breaks down promises, async/await, and the event loop. March 31, 2026 Read more" [ref=e224] [cursor=pointer]:
                        - /url: /blog/async-javascript-explained
                        - img "Async JavaScript Explained (Promises, Async/Await, Event Loop)" [ref=e226]
                        - generic [ref=e227]:
                            - generic [ref=e228]:
                                - generic [ref=e229]: JavaScript
                                - generic [ref=e230]: 15 min read
                            - heading "Async JavaScript Explained (Promises, Async/Await, Event Loop)" [level=3] [ref=e231]
                            - paragraph [ref=e232]: When you click a button or fetch data from an API, JavaScript keeps moving forward while handling tasks in the background. This guide breaks down promises, async/await, and the event loop.
                            - generic [ref=e233]:
                                - generic [ref=e234]: March 31, 2026
                                - generic [ref=e235]:
                                    - text: Read more
                                    - img [ref=e236]
