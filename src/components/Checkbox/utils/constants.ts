...
export const DEFAULT_CHECKBOX_CLASSES: Required<CheckboxClasses> = {
  ...
  checkbox: "inline-flex items-center justify-center border-2 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-cl-accent focus-visible:ring-offset-2 dark:focus-visible:ring-offset-cl-bg",
  checked: "bg-cl-accent dark:bg-cl-accent border-cl-border-input-focus dark:border-cl-border-input-focus text-white",
  unchecked: "bg-white dark:bg-cl-bg-elevated border-cl-border-input dark:border-cl-border",
  indeterminate: "bg-cl-accent dark:bg-cl-accent border-cl-border-input-focus dark:border-cl-border-input-focus text-white",
  icon: "",
