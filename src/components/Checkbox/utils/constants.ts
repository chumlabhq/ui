...
export const DEFAULT_CHECKBOX_CLASSES: Required<CheckboxClasses> = {
  ...
  checked: "bg-blue-600 dark:bg-blue-500 border-blue-600 dark:border-blue-500 text-white",
  unchecked: "bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600",
  indeterminate: "bg-blue-600 dark:bg-blue-500 border-blue-600 dark:border-blue-500 text-white",
  icon: "",
