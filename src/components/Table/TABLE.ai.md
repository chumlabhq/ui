...
| `loading` | boolean | — | Whether the table is in a loading state showing shimmer rows. |
| `showHeader` | boolean | — | Whether to show the table header row. |
...
| `maxPinnedColumns` | number | — | Maximum number of columns that can be pinned simultaneously. |
...
| `isFloatingActionsHovered` | boolean | — | Whether the floating actions area is being hovered. |
| `isPopupOpen` | boolean | — | Whether a popup triggered from the table is currently open. |
...
| `hideVerticalScrollbar` | boolean | — | Whether to hide the vertical scrollbar. |
| `hideHorizontalScrollbar` | boolean | — | Whether to hide the horizontal scrollbar. |
| `stickyHeader` | boolean | — | Whether the header row sticks to the top when scrolling. |
...
| `shimmerRowCount` | number | — | Number of shimmer rows to display while loading. |
...
| `manualSorting` | boolean | — | When true, sorting is handled server-side. |
...
| `enableColumnFilters` | boolean | — | Enable per-column filtering. |
...
| `expandColumnPosition` | `"left"` \| `"right"` | — | Position of the expand column. |
| `expandOnRowClick` | boolean | — | Make the entire row clickable to toggle expansion. |
...
| `editable` | boolean | — | Enable inline cell editing on double-click. |
...
| `enableColumnResizing` | boolean | — | Enable column resizing via drag handles. |
...
| `manualPagination` | boolean | — | When true, pagination is handled server-side. |
| `manualFiltering` | boolean | — | When true, filtering is handled server-side. |
...
| `enableRowDragDrop` | boolean | — | Enable row drag-and-drop reordering. |
| `onRowReorder` | object | — | (fromIndex: number, toIndex: number) => void — Callback when a row is reordered. |
| `dragColumnPosition` | `"left"` \| `"right"` | — | Position of the drag handle column. |
...
| `showSearch` | boolean | — | Show a built-in search bar above the table. |
| `searchPlaceholder` | string | — | Placeholder text for the search bar. |
| `searchIconPosition` | `"left"` \| `"right"` \| `"none"` | — | Position of the search icon. |
