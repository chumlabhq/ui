...
const Faq = () => {
  useDocumentTitle(
    "FAQ — Answers to Common Questions About Chumlab UI"
  );
  ...
  return (
    <div className="relative min-h-screen bg-[#04040a] text-white overflow-x-hidden">
      ...
      <main className="pt-[72px]">
        {/* ══ HERO ══ */}
        <section className="px-6 sm:px-10 pt-20 pb-6">
        ...
        {/* ══ FAQ ACCORDION ══ */}
        <section className="px-6 sm:px-10 pt-4 pb-12">
        ...
        <section className="px-6 sm:px-10 py-20">
          <div className="max-w-4xl mx-auto">
            <div className="relative rounded-2xl border border-white/[0.08] bg-white/[0.02] p-10 sm:p-14 text-center overflow-hidden">
