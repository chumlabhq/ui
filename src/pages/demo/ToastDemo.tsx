    ...
    <div className="space-y-16">
      <header>
        ...
        <p className={`text-lg ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
          A flexible, accessible notification system for displaying brief messages to users.
          Supports multiple variants, customizable durations, progress indicators, custom content,
...
function MyComponent() {
        ...
        >
          ...
          <div className={`mt-4 p-3 rounded-lg ${isDarkMode ? "bg-blue-900/30 border border-blue-800" : "bg-blue-50 border border-blue-200"}`}>
            <p className={`text-sm ${isDarkMode ? "text-blue-200" : "text-blue-800"}`}>
              ...
              on ToastProvider to enable Escape dismissal for all toasts globally.
            </p>
          </div>
        </Section>
        ...
        >
          <DemoWrapper isDarkMode={isDarkMode}>
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className={`p-3 rounded-lg ${isDarkMode ? "bg-blue-900/30 border border-blue-800" : "bg-blue-50 border border-blue-200"}`}>
                <p className={`text-sm ${isDarkMode ? "text-blue-200" : "text-blue-800"}`}>
  ...
  --toast-default-text: white;
          ...
          <DemoWrapper isDarkMode={isDarkMode}>
            <div className="flex flex-col gap-4 w-full">
              ...
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                The <code className={`px-1 py-0.5 rounded text-xs font-mono ${isDarkMode ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-700"}`}>toast()</code> methods return a unique ID that can be used with <code className={`px-1 py-0.5 rounded text-xs font-mono ${isDarkMode ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-700"}`}>dismiss(id)</code>.
              </p>
            </div>
          </DemoWrapper>
        </Section>
        ...
        >
          ...
          <div className={`mt-4 p-3 rounded-lg ${isDarkMode ? "bg-amber-900/30 border border-amber-800" : "bg-amber-50 border border-amber-200"}`}>
            <p className={`text-sm ${isDarkMode ? "text-amber-200" : "text-amber-800"}`}>
              <strong>Tip:</strong> Configure{" "}
              <code className={`px-1 py-0.5 border rounded text-xs font-mono ${isDarkMode ? "bg-gray-800/80 border-gray-600 text-gray-300" : "bg-white border-gray-300 text-gray-700"}`}>
                maxToasts
              </code>{" "}
              on ToastProvider to control the maximum visible toasts (default: 5).
            </p>
          </div>
        </Section>
        ...
        >
          <DemoWrapper isDarkMode={isDarkMode}>
            <div className="flex flex-col gap-4 w-full">
              ...
              <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
                Current position: <strong className={isDarkMode ? "text-white" : "text-gray-900"}>{position}</strong>
              </p>
              <Button
                className={styles.info}
                onClick={() => toast.info(`Toast at ${position}`, { description: "See the position in action!" })}
              >
            ...
            <table className={`min-w-full text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}>
              ...
              <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-100"}`}>
                <tr>
                  ...
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>"info"</td>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">duration</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>number</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>5000</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Auto-dismiss time in ms (Infinity for persistent)
                  </td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">showProgress</td>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">progressColor</td>
                ...
                <tr>
                  ...
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>ReactNode</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>Type icon</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Custom icon (overrides type-based default)
                  </td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">showCloseButton</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>boolean</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>true</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">pauseOnHover</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>boolean</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>true</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">dismissOnEscape</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>boolean</td>
          ...
          <div className="overflow-x-auto">
            <table className={`min-w-full text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}>
              ...
              <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-100"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">messageClassName</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>string</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">progressClassName</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>string</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">closeButtonClassName</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>string</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
          ...
          <div className="overflow-x-auto">
            <table className={`min-w-full text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}>
              ...
              <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-100"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">position</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>ToastPosition</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>"bottom-right"</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Screen position for toast container
                  </td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">maxToasts</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>number</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>5</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Maximum visible toasts (older ones auto-dismissed)
                  </td>
                </tr>
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">defaultDuration</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>number</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>5000</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  ...
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>number</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>12</td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
            ...
            <table className={`min-w-full text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}>
              <thead>
                <tr className={`border-b ${isDarkMode ? "border-gray-700" : "border-gray-200"}`}>
                  ...
                  <th className="text-left py-3 pr-4 font-semibold">Signature</th>
                  <th className="text-left py-3 font-semibold">Description</th>
                </tr>
              </thead>
              <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-100"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">dismissAll</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    () =&gt; void
                  </td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
  ...
  dismissAll: () => void;
        ...
        <div>
          ...
          <div className="overflow-x-auto">
            <table className={`min-w-full text-sm ${isDarkMode ? "text-gray-300" : "text-gray-900"}`}>
              ...
              <tbody className={`divide-y ${isDarkMode ? "divide-gray-700" : "divide-gray-100"}`}>
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">data-toast-id</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Toast container
                  </td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">data-toast-type</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Toast container
                  </td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                ...
                <tr>
                  <td className="py-3 pr-4 font-mono text-blue-500">data-paused</td>
                  <td className={`py-3 pr-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                    Toast container
                  </td>
                  <td className={`py-3 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
      ...
      <div className="space-y-6">
        ...
        <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-800" : "bg-gray-50"}`}>
          ...
          <ul className={`list-disc list-inside space-y-2 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
            ...
            <li>
              Use appropriate toast types to convey meaning (error for failures, success for completions)
            </li>
            <li>
              Avoid using toasts for critical information that requires acknowledgment (use modals instead)
            </li>
            <li>
              Provide sufficient duration for users to read content
            </li>
            <li>
              Use persistent toasts sparingly (only for important, ongoing states)
            </li>
            <li>
              Consider using{" "}
              <code className={`px-1.5 py-0.5 rounded text-sm ${isDarkMode ? "bg-gray-700" : "bg-gray-200"}`}>
      ...
      <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-800 border border-gray-700" : "bg-gray-50 border border-gray-200"}`}>
        <p className={`text-sm ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
          ...
          to render toasts outside the normal DOM hierarchy. This ensures toasts appear above all other content
          regardless of z-index stacking in the parent application. Customize the portal z-index using the{" "}
          <code className={`px-1.5 py-0.5 rounded text-xs font-mono ${isDarkMode ? "bg-gray-700 text-gray-300" : "bg-gray-100 text-gray-700"}`}>
            zIndex
          </code>{" "}
